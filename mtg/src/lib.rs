...
use mtg_action::MtgAction;
pub use mtg_engine_core::ids::{ActionId, IdGenerator, ObserverId, PlayerId};
use mtg_engine_core::{
    game::{ActionQueue, GameDomain, GameTimestamp},
    ids::{ObjectId, ZoneId},
    make_id_type,
};
use player_inputs::MtgInput;
use steps::{StartingStep, Step, SubStep};
...
impl GameDomain for MtgGameState {
    type Input = MtgInput;
...
impl MtgGameBuilder {
    ...
    pub fn build(self) -> mtg_engine_core::game::Game<MtgGameState> {
